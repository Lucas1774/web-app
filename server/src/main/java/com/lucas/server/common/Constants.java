...
public class Constants {
    ...
    public static final List<Clients> RECOMMENDATION_CLIENTS = List.of(FIRST, SECOND, THIRD, SIXTH, SEVENTH, EIGHTH);
    public static final List<Clients> RANDOM_RECOMMENDATION_CLIENTS = List.of(FOURTH, FIFTH, SIXTH, SEVENTH, EIGHTH);
