...
public class Constants {
    ...
    public static final List<Clients> RECOMMENDATION_CLIENTS = List.of(GPT_4_1, GPT_4O, GROK_3, DEEPSEEK_V3, LLAMA_3_3_70B, LLAMA_3_1_405B);
    public static final List<Clients> RANDOM_RECOMMENDATION_CLIENTS = List.of(GPT_4_1, GPT_4O, GROK_3, DEEPSEEK_V3, LLAMA_3_3_70B, LLAMA_3_1_405B);
