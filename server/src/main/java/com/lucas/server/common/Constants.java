...
public class Constants {
    ...
    public static final List<Clients> RECOMMENDATION_CLIENTS = List.of(GPT_4_1, DEEPSEEK_V3, GROK_3, GPT_4O);
    public static final List<Clients> RANDOM_RECOMMENDATION_CLIENTS = List.of(LLAMA_3_3_70B, LLAMA_3_1_405B, LLAMA_3_1_70B,
            MISTRAL_LARGE, GPT_4_1_MINI, PHI_4, GPT_4O_MINI, MISTRAL_NEMO, LLAMA_3_1_8B, MINISTRAL_3B, GPT_4_1_NANO, COMMAND_A);
