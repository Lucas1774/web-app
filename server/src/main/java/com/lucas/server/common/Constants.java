...
public class Constants {
    ...
    public static final int SCHEDULED_RECOMMENDATIONS_COUNT = 480;
    ...
    public static final List<Clients> RECOMMENDATION_CLIENTS = List.of(ONE, TWO, THREE, FOUR);
    public static final List<Clients> RANDOM_RECOMMENDATION_CLIENTS = List.of(FIVE, SIX, SEVEN, EIGHT, NINE, TEN, ELEVEN, TWELVE, THIRTEEN, FOURTEEN);
